---
title: "What to Do If Your Mock Results Were Disappointing"
description: "Got lower mock results than expected? Mocks are not the final outcome. This guide explains what mock results really mean, how to use them, and practical steps to improve before your real A-Level exams."
date: 2026-02-20
type: article
tags:
  - resource
...
You have roughly 12 weeks between now and the start of A-Level exams in May. That is a significant amount of time if you use it well. Our guide on [creating a revision timetable](/resources/creating-revision-timetable/) goes into this in detail, but here are the essentials.

### Prioritise Ruthlessly

You cannot revise everything equally. Use your mock analysis to rank topics by two factors:

1. **How many marks are available** for this topic in the real exam
2. **How weak you are** on this topic based on your mock performance
...
Check our guide on [proven revision techniques](/resources/10-proven-revision-techniques/) for more evidence-based strategies.
...
If you are struggling with a specific subject, [private tuition](/private-tuition/) can provide targeted support that addresses your individual weaknesses. A good tutor will work from your mock paper to build a personalised improvement plan.
...
**Talk to someone if you are struggling.** If disappointing mocks have left you feeling overwhelmed, anxious, or low, speak to a parent, teacher, or school counsellor. Our guide on [managing exam anxiety](/resources/managing-exam-anxiety/) covers this in more detail.
...
If your mock results suggest your current offers may be out of reach, it is not too early to research alternative courses, institutions, or pathways through [UCAS Clearing](/resources/ucas-clearing-guide/).

### Start Thinking About Plan B

Having a backup plan is not defeatist. It is sensible. Options include:

- **Retaking A-Levels** in the autumn or the following summer: [our guide to A-Level retakes](/a-level-retakes/) explains the process
- **Taking a gap year** to retake while gaining experience: see our [gap year vs retakes](/resources/gap-year-vs-retakes/) comparison
- **Retaking as a private candidate** if you have left school: read about [how to retake A-Levels privately](/resources/how-to-retake-a-levels-privately/)
...
With mocks behind you, the exam timeline now moves quickly. Our [A-Level key dates 2026](/resources/a-level-key-dates-2026/) guide has the full timetable, but the critical milestones are:
...
[Make an enquiry](/enquiry/) to discuss your situation and explore your options.
